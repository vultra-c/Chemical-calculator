...
- 当前版本：`V26.9.48.CALC`（versionCode 2609480）
...
10. **化学速查**：元素周期表（118 全量按原子序数）/ 金属活动性顺序 / 常见元素化合价（含化合价口诀）/ 常见根与酸根化合价（含根价口诀）/ 常见离子符号（36 种，右上标 + ASCII 电荷双展示与读法提示）/ 常见不溶物 / 常见物质颜色 / 常见气体制取与检验 / 相对原子质量表九组速查，滚动分组展示。
