...
- 当前版本：`V26.8.46.CALC`（versionCode 2608460）
...
9. **常量显示**：阿伏伽德罗常数、气体摩尔体积等常用化学常数速查。
10. **化学速查**：金属活动性顺序 / 常见元素化合价 / 常见根与酸根化合价 / 常见不溶物 / 相对原子质量表五组速查，滚动分组展示。
11. **化学专属输入法**：中文连打词库替换为化学专属（物质名 + 元素名 + 仪器/概念术语，整词候选优先）；英文按原样直输不做中文联想。
...
| `pages/element` | 元素查询页：按元素检索本地反应库（232 条方程式索引） |
...
├── tests/smoke.mjs         # Node 冒烟测试（88 项断言）
