 ...
 * 覆盖初中化学考试常用换算与常数。
 * 注意：手表字体缺 Unicode 上标字形（²³⁻¹ 显示空白），数值一律 ASCII 书写
 * （10^23、10^-14、g/cm3、J/(mol·K)）。
 */
export const CONSTANTS = [
  { name: '阿伏伽德罗常数 N_A', value: '6.022×10^23 /mol', note: '约 6.02×10^23' },
  { name: '气体摩尔体积 V_m', value: '22.4 L/mol', note: '标准状况（0 ℃、101 kPa）' },
  { name: '水的离子积 K_w', value: '1.0×10^-14', note: '25 ℃' },
  ...
  { name: '水的密度 ρ', value: '1.0 g/cm3', note: '4 ℃ 时最大' },
