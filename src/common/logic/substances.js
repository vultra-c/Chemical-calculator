...
export const NAME_MAP = {
  ...
  '钨': 'W', '溴': 'Br2', '碘': 'I2', '单质溴': 'Br2', '溴水': 'Br2', '碘水': 'I2',
  '氟气': 'F2',
  ...
  '铁锈主要成分': 'Fe2O3', '铁锈': 'Fe2O3', '四氧化三铁': 'Fe3O4',
  ...
  '碳酸铵': '(NH4)2CO3',
  '氨气': 'NH3',
  '氯化铁': 'FeCl3', '氯化亚铁': 'FeCl2',
  '溴化钠': 'NaBr', '溴化钾': 'KBr', '碘化钠': 'NaI', '碘化钾': 'KI',
  '偏铝酸钠': 'NaAlO2',
  '次氯酸': 'HClO', '次氯酸钠': 'NaClO', '次氯酸钙': 'Ca(ClO)2',
  '硅酸': 'H2SiO3', '硅酸钠': 'Na2SiO3',
  '氢硫酸': 'H2S', '硫化氢': 'H2S',
  '硫酸钙': 'CaSO4', '亚硫酸钠': 'Na2SO3', '亚硫酸钙': 'CaSO3', '亚硫酸钡': 'BaSO3',
  '亚硝酸钾': 'KNO2', '亚硝酸钠': 'NaNO2',
  '硫代硫酸钠': 'Na2S2O3', '硫化亚铁': 'FeS', '氮化镁': 'Mg3N2',
...
export const CATALOG = [
  {
    group: '金属单质',
    items: ['K', 'Ca', 'Na', 'Mg', 'Al', 'Zn', 'Fe', 'Sn', 'Pb', 'Cu', 'Hg', 'Ag', 'Au', 'W']
  },
  {
    group: '非金属单质',
    items: ['H2', 'O2', 'N2', 'Cl2', 'C', 'S', 'P', 'Si', 'Br2', 'I2']
  },
  {
    group: '氧化物',
    items: ['H2O', 'H2O2', 'CO', 'CO2', 'SO2', 'SO3', 'P2O5', 'NO2', 'MnO2', 'SiO2',
      'MgO', 'CaO', 'Na2O', 'Na2O2', 'CuO', 'Fe2O3', 'Fe3O4', 'Al2O3', 'ZnO', 'BaO', 'Ag2O', 'HgO', 'PbO', 'WO3']
  },
  {
    group: '酸',
  ...
  {
    group: '碱',
    items: ['NaOH', 'KOH', 'Ca(OH)2', 'Ba(OH)2', 'Mg(OH)2', 'Cu(OH)2', 'Fe(OH)2', 'Fe(OH)3', 'Al(OH)3', 'Zn(OH)2', 'NH3']
  },
  {
    group: '盐',
    items: ['NaCl', 'KCl', 'BaCl2', 'CaCl2', 'MgCl2', 'CuCl2', 'ZnCl2', 'AlCl3', 'AgCl', 'FeCl3', 'FeCl2',
      'CuSO4', 'ZnSO4', 'FeSO4', 'Fe2(SO4)3', 'Na2SO4', 'K2SO4', 'BaSO4', 'MgSO4', 'CaSO4',
      'NaNO3', 'KNO3', 'AgNO3', 'Ba(NO3)2', 'Cu(NO3)2',
      'CaCO3', 'Na2CO3', 'NaHCO3', 'K2CO3', 'BaCO3', 'MgCO3',
      'Na2SO3', 'CaSO3', 'NaNO2', 'BaSO3',
      'KMnO4', 'K2MnO4', 'KClO3', 'Cu2(OH)2CO3', 'Ca(HCO3)2',
      'NH4Cl', '(NH4)2SO4', '(NH4)2CO3', 'NH4HCO3', 'NH4NO3', 'NH3']
  },
  {
    group: '有机物',
