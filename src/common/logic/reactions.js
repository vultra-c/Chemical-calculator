...
// ---- V26.9.56 考试补充：卤素置换 ----
// 活泼卤素单质把不活泼卤素从其盐溶液中置换出来（Cl2 > Br2 > I2）
addSpec(['Cl2', 'NaBr'], ['NaCl', 'Br2'], '置换反应', '')
addSpec(['Cl2', 'KBr'], ['KCl', 'Br2'], '置换反应', '')
addSpec(['Cl2', 'NaI'], ['NaCl', 'I2'], '置换反应', '')
addSpec(['Cl2', 'KI'], ['KCl', 'I2'], '置换反应', '')
addSpec(['Br2', 'NaI'], ['NaBr', 'I2'], '置换反应', '')
addSpec(['Br2', 'KI'], ['KBr', 'I2'], '置换反应', '')

// ---- V26.9.56 考试补充：铁三角 ----
addSpec(['Fe', 'FeCl3'], ['FeCl2'], '氧化还原反应', '（铁离子遇铁归中为亚铁）')
addSpec(['Cu', 'FeCl3'], ['CuCl2', 'FeCl2'], '氧化还原反应', '（FeCl3 溶液刻蚀铜箔）')

// ---- V26.9.56 考试补充：铝的两性 ----
addSpec(['Al2O3', 'NaOH'], ['NaAlO2', 'H2O'], '复分解反应', '')
addSpec(['Al(OH)3', 'NaOH'], ['NaAlO2', 'H2O'], '复分解反应', '')
addSpec(['Al', 'NaOH', 'H2O'], ['NaAlO2', 'H2'], '置换反应', '')

// ---- V26.9.56 考试补充：硝酸体系（浓硝酸氧化性） ----
addSpec(['Cu', 'HNO3'], ['Cu(NO3)2', 'NO2', 'H2O'], '氧化还原反应', '浓硝酸\n（稀硝酸则生成 NO 气体）')
addSpec(['C', 'HNO3'], ['CO2', 'NO2', 'H2O'], '氧化还原反应', '浓硝酸、加热')

// ---- V26.9.56 考试补充：氯水与漂白 ----
addSpec(['Cl2', 'H2O'], ['HCl', 'HClO'], '氧化还原反应', '（氯水成分考点）')
addSpec(['Cl2', 'NaOH'], ['NaCl', 'NaClO', 'H2O'], '氧化还原反应', '（漂白液制取）')
addSpec(['Cl2', 'Ca(OH)2'], ['CaCl2', 'Ca(ClO)2', 'H2O'], '氧化还原反应', '（漂白粉制取）')

// ---- V26.9.56 考试补充：硅及其化合物（玻璃工业） ----
addSpec(['SiO2', 'NaOH'], ['Na2SiO3', 'H2O'], '复分解反应', '')
addSpec(['SiO2', 'CaO'], ['CaSiO3'], '化合反应', '高温')
addSpec(['Na2SiO3', 'HCl'], ['H2SiO3', 'NaCl'], '复分解反应', '（酸性 HCl > H2SiO3）')

// ---- V26.9.56 考试补充：硫化物与过氧化物 ----
addSpec(['FeS', 'HCl'], ['FeCl2', 'H2S'], '复分解反应', '')
addSpec(['FeS', 'H2SO4'], ['FeSO4', 'H2S'], '复分解反应', '稀硫酸')
addSpec(['Na2O2', 'SO2'], ['Na2SO4'], '氧化还原反应', '')

// ---- V26.9.56 考试补充：其他 ----
addSpec(['Al', 'Fe3O4'], ['Al2O3', 'Fe'], '置换反应', '高温（铝热）')
addSpec(['NaCl', 'H2O'], ['NaOH', 'H2', 'Cl2'], '分解反应', '通电电解（饱和食盐水）')
